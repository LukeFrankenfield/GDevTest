...
public class BunnyHead extends AbstractGameObject {
	...
	/**
	 * initialize fields for BunnyHead on creation
	 */
	public void init(){
		dimension.set(1,1);
	...
	/**
	 * Handles jumping behaviour and changes the jumpState accordingly
	...
	public void setJumping (boolean jumpKeyPressed){
		...
		case GROUNDED: // Character is standing on a platform
			...
			break;
		case JUMP_RISING: // rising in air
			if(!jumpKeyPressed)
	...
	/**
	 * Setter for Feather Powerup
	 * @param pickedUp
	 */
	public void setFeatherPowerup (boolean pickedUp){
		hasFeatherPowerup = pickedUp;
		if (pickedUp) // sets timer if powered up
			timeLeftFeatherPowerup = Constants.ITEM_FEATHER_POWERUP_DURATION;
	};
	/**
	 * Tells if the bunny has the feather powerup
	...
	protected void updateMotionY (float deltaTime){
		...
		case JUMP_FALLING:
			...
			timeJumping += deltaTime;
			// jump to a minimal height if jump key was pressed too short
